...
class DemoHidingCheckBox(twd.HidingTableLayout):
    ...
    delivery = twd.HidingCheckBox(
        label_text='Delivery required?',
        mapping={1: ['address']})
...
class DemoHidingCheckBoxList(twd.HidingTableLayout):
    ...
    contact = twd.HidingCheckBoxList(
        label_text='Contact method',
...
class DemoHidingRadioButtonList(twd.HidingTableLayout):
    ...
    contact = twd.HidingRadioButtonList(
        label_text='Contact method',
        options=('E-mail', 'Phone', 'SMS'),
        mapping={
            'E-mail': ['email_address'],
...
class DemoHidingSingleSelectField(twd.HidingTableLayout):
    ...
    contact = twd.HidingSingleSelectField(
        label_text='Contact method',
        options=('E-mail', 'Phone', 'SMS'),
        mapping={
            'E-mail': ['email_address'],
...
class DemoLinkContainer(twd.LinkContainer):
    child = twf.SingleSelectField(
        options=('', 'www.google.com', 'www.yahoo.com'))
    link = 'http://$'
